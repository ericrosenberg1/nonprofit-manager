...
5. Donation form with PayPal and Venmo options
...
= 1.1.2 =
Bug fix for dashboard widget member count. Recommended update.

= 1.1.1 =
Bug fix for Venmo payment button functionality. Recommended update.

= 1.1 =
Major update with newsletter templates, improved security, and better UI consistency. Recommended for all users.
