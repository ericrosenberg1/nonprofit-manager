...
add_action('admin_init', function () {
    if (
        ...
        update_option('npmp_enabled_features', $enabled_features);
    ...
    <div class="wrap">
        ...
        <form method="post">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="npmp_feature_members" <?php checked($features['members']); ?>>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="npmp_feature_newsletters" <?php checked($features['newsletters']); ?> <?php disabled(!$features['members']); ?>>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="npmp_feature_donations" <?php checked($features['donations']); ?>>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="npmp_feature_calendar" <?php checked($features['calendar']); ?> disabled>
        ...
        <ul>
            <?php if (!empty($features['members'])): ?>
                <li><a href="admin.php?page=npmp_members"><?php esc_html_e('Members Page', 'nonprofit-manager'); ?></a> – View, add, and manage members and subscribers.</li>
                <li><a href="admin.php?page=npmp_email_settings"><?php esc_html_e('Email Settings', 'nonprofit-manager'); ?></a> – Connect your email service and customize membership forms.</li>
            <?php endif; ?>
            <?php if (!empty($features['donations'])): ?>
                <li><a href="admin.php?page=npmp_payment_settings"><?php esc_html_e('Donation Settings', 'nonprofit-manager'); ?></a> – Set up PayPal for donation collection.</li>
            <?php endif; ?>
        </ul>
        ...
        <ol>
            <?php if (!empty($features['members'])): ?>
                <li><strong><?php esc_html_e('Email Setup:', 'nonprofit-manager'); ?></strong> Go to <a href="admin.php?page=npmp_email_settings">Email Settings</a> and connect your transactional email provider.</li>
            <?php endif; ?>
            <?php if (!empty($features['donations'])): ?>
                <li><strong><?php esc_html_e('Payment Gateway:', 'nonprofit-manager'); ?></strong> Configure <a href="admin.php?page=npmp_payment_settings">Payment Settings</a> to enable online donations.</li>
            <?php endif; ?>
