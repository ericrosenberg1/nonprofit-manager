...
(function($) {
    ...
    $(document).ready(function() {
        ...
        window.npRedirectToPayPal = function() {
            ...
            const nonceValue = document.getElementById("npmp_paypal_success_nonce").value;
            ...
            paypal.Buttons({
                ...
                onApprove: function(data, actions) {
                    return actions.order.capture().then(function(details) {
                        ...
                        const nonce = document.querySelector("input[name=npmp_paypal_donation_nonce_field]").value;
